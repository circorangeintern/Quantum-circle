...
const titles = {
  ...
  "/superadmin/requests": "School Requests",
};
...
export function SuperAdminTopbar({ pathname }) {
    ...
    <div className="flex items-center justify-between px-4 sm:px-7 py-3.5 sm:py-4 border-b border-border bg-white sticky top-0 z-20 overflow-hidden">
      <div className="flex items-center gap-3 min-w-0">
        ...
        <h2 className="text-[16px] sm:text-[19px] font-display text-navy flex items-center gap-2 flex-wrap min-w-0">
          ...
          <span className="hidden sm:inline-flex items-center bg-red-light text-red text-[10.5px] font-extrabold uppercase tracking-wider px-2.5 py-1 rounded-full shrink-0">
            Super Admin
          </span>
        </h2>
      </div>
